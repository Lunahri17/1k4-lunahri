/*Desarrolla una funci�n recursiva que permita dividir en forma entera un numero positivo a,
mayor a cero por otro n�mero positivo b, menor que a, aplicando el principio de �determinar
cu�ntas veces cabe b en a aplicando restas sucesivas�. */
